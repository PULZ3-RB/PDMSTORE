...
export async function onRequestPost(context) {
  try {
    if (!context.env.DISCORD_RESERVATIONS_WEBHOOK_URL) {
      return json({ ok: false, error: "Falta configurar DISCORD_RESERVATIONS_WEBHOOK_URL." }, 500);
    }
    ...
    const payload = {
      ...
      embeds: [{
        ...
        fields: [
          ...
          { name: "Disponibilidad", value: publicVehicle.stock > 0 ? `Unidad inmediata (${publicVehicle.stock})` : "Solo por reserva", inline: true }
        ],
